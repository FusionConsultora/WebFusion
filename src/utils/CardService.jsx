...
const CardService = ({ image, title, subtitle, contact }) => {
    return (
        <div className={`w-64 h-[20rem] flex flex-col justify-center items-center m-3 p-4 rounded-xl ${style.shadowCard}`}>
            ...
            <a href="https://api.whatsapp.com/send/?phone=5491166863363&text=Buenos+dias%2C+estoy+interesado+en+los+servicios+que+ofrecen%21&type=phone_number&app_absent=0"
                target="_blank"
                rel="noreferrer"
